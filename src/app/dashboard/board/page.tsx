...
export default async function DispatchBoardPage() {
  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-6">
      <h1 className="text-lg font-semibold text-black dark:text-zinc-50">Dispatch board</h1>

      {error && <p className="text-red-600 dark:text-red-400">Couldn&apos;t load orders.</p>}
          ...
          <div className="flex flex-col gap-2">
            {group.orders.map((order) => {
              ...
              return (
                <div
                  key={order.id}
                  className="flex flex-col gap-2 rounded-lg border border-zinc-200 bg-white p-3 sm:flex-row sm:items-center sm:justify-between dark:border-zinc-800 dark:bg-zinc-950"
                >
