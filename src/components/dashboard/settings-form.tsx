...
export function SettingsForm({ initialValue }: { initialValue: string }) {
  ...
  return (
    <section className="mx-auto flex max-w-md flex-col gap-3 rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-950">
      <h1 className="font-medium text-black dark:text-zinc-50">Bank transfer details</h1>
